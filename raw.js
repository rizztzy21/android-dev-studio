...
const nullHexs = [
  ...
  "\x04",        // EOT
  "\x09",        // TAB
  "\x0A",        // LF (new line) - BERBAHAYA untuk header
  "\x0D",        // CR (carriage return) - BERBAHAYA untuk header
  "\x1B",        // ESC
  "\x7F",        // DEL
  "\x80",        // C1 start
  "\xA0",        // NBSP (single byte in Windows-1252, UTF-8 often C2 A0)
  "\xC2\xA0",    // UTF-8 NBSP (two-byte)
  "\xEF\xBB\xBF",// UTF-8 BOM (three-byte)
  "\xE2\x80\x8B",// zero-width space (U+200B)
  "\u200B",      // same as above, nicer readable form
  "\xFF"         // 0xFF
];
